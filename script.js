...
function sortMarks(){
    let sortedarr = arr.sort((a,b)=>a.marks-b.marks)
    render(sortedarr)
}
function sortPassing(){
    let sortedarr = arr.filter((item)=>item.passing == true)
    render(sortedarr)
}
function sortClass(){
    let sortedarr = arr.sort((a,b)=>a.class-b.class)
    render(sortedarr)
}
function sortGender(){
    let arr1 = arr.filter((item)=>item.gender=="Male")
    let arr2 = arr.filter((item)=>item.gender=="Female")
    genderRender(arr1,arr2)
}

function searching(){
    let input = document.getElementById("searchbox").value.toLowerCase()
    let searchArr = arr.filter((item)=>item.first_name.toLowerCase().includes(input) || item.last_name.toLowerCase().includes(input) || item.email.toLowerCase().includes(input))
    render(searchArr)
}
...
function genderRender(arr1,arr2){
    let main = document.getElementById("main")
    main.innerHTML=""
